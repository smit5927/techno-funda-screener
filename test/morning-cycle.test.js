...
test("morning approval is limited to the weekday 08:20-09:05 IST recovery window", () => {
  ...
  assert.equal(isMorningApprovalWindow("2026-07-20T03:36:00.000Z"), false); // 09:06 IST
...
test("a delayed GitHub morning schedule becomes a data refresh without approvals or alerts", () => {
  ...
  assert.equal(late.reason, "outside-08:20-to-09:05-IST");
});
