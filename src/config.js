...
export const appConfig = {
  ...
  trade: {
    ...
    initialMaxPositionPct: numberEnv("TRADE_INITIAL_MAX_POSITION_PCT", 7.5),
    initialRiskPct: numberEnv("TRADE_INITIAL_RISK_PCT", 0.7),
    ...
    controlledRetestEnabled: boolEnv("TRADE_CONTROLLED_RETEST_ENABLED", true),
    controlledRetestAddMaxPct: numberEnv("TRADE_CONTROLLED_RETEST_ADD_MAX_PCT", 2.5),
    controlledRetestAddRiskPct: numberEnv("TRADE_CONTROLLED_RETEST_ADD_RISK_PCT", 0.3),
    controlledRetestMaxPositionPct: numberEnv("TRADE_CONTROLLED_RETEST_MAX_POSITION_PCT", 10),
    controlledRetestMinDrawdownR: numberEnv("TRADE_CONTROLLED_RETEST_MIN_DRAWDOWN_R", 0.25),
    controlledRetestMaxDrawdownR: numberEnv("TRADE_CONTROLLED_RETEST_MAX_DRAWDOWN_R", 0.75),
